...
; Vasya: future-steps - множество возможных шагов
figures-own [domain future-steps]
edges-own [weight]
...
; Vasya: прибирає фігури з дошки і ресетить їх
to reset-figure
...
; Vasya: замінив кольори на шахи, додав future-steps і reset-figures
to-report dfs [n]
  let i [who] of n
  foreach all-positions [
    [a] ->
...
; Vasya: зробив свій метод для перевірки порушень
