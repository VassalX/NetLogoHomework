...
to store-initial-turtle-counts
  ...
  set num-soft-gruder n-soft-gruder
end
...
to make-turtles
  ...
  create-turtles num-soft-gruder [set strategy "soft-gruder" set color cyan]
end
...
to setup-common-variables
  ask turtles [
    ...
    set soft-gruder-states n-values count turtles [-1]
  ]
...
to select-action ;;turtle procedure
  ...
  if strategy = "soft-gruder" [ soft-gruder ]
end
...
to update-history
  ...
  if strategy = "soft-gruder" [ soft-gruder-history-update ]
end
...
to do-scoring
  ...
  set soft-gruder-score (calc-score "soft-gruder" num-soft-gruder)
end
...
"soft-gruder" 1.0 0 -6459832 true "" "if num-soft-gruder-games > 0 [ plot soft-gruder-score / (num-soft-gruder-games) ]"
