...
to setup
  clear-all
  ; place the computer
  set pavlov-seq [true true true true false false]
  ...
  set hidden-strategy one-of [
    ...
    "tit-for-two-tats" "unforgiving" "pavlov"
  ]
  reset-ticks
...
to pavlov
  ifelse random 100 < pavlov-random [
    ...
    if not (prev-payoff = 3 or prev-payoff = 5) [
      set defect-now? not defect-now?
    ]
  ]
end
...
to get-payoff ; Turtle Procedure
  ...
  set history fput defect-now? history
...
human-strategy
human-strategy
"act-randomly" "cooperate" "defect" "tit-for-tat" "tit-for-two-tats" "unforgiving" "pavlov"
1
...
300
computer payoff
[ prev-payoff ] of one-of computers
17
1
11
...
<experiments>
  <experiment name="experiment" repetitions="1" runMetricsEveryStep="false">
    ...
    <go>play</go>
    <timeLimit steps="500"/>
    <metric>[ average-score ] of one-of users</metric>
    <metric>[ average-score ] of one-of computers</metric>
    <metric>[ score ] of one-of users</metric>
    <metric>[ score ] of one-of computers</metric>
